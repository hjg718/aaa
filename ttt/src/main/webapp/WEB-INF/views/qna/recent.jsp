...
<dt>제목 :</dt>
  <dd><p>${recent.title}</p></dd>
  <dt>작성자 :</dt>
  <dd><p>${recent.author}</p></dd>
     <dt>작성일 :</dt>
  <dd><p>${recent.bdate}</p></dd>
  <dt>내용 :</dt>
  <dd>
  <pre>${recent.qcontents}</pre>
  </dd>
</dl>
...
<input type="hidden" name="${_csrf.parameterName }"	value="${_csrf.token }">
<input type="hidden" name="num" value="${recent.num }">
<input type="hidden" name="pwd" value="${recent.pwd }">
</form>
